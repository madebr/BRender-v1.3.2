...
void BR_ASM_CALL PointRender_Blend(brp_block *block, brp_vertex *v0);
void BR_ASM_CALL PointRender_BlendSmooth(brp_block *block, brp_vertex *v0);
void BR_ASM_CALL PointRender_Fog(brp_block *block, brp_vertex *v0);
void BR_ASM_CALL PointRender_Fog_Blend(brp_block *block, brp_vertex *v0);
void BR_ASM_CALL PointRender_Fog_BlendSmooth(brp_block *block, brp_vertex *v0);
void BR_ASM_CALL LineRender_Smooth(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Smooth_Blend(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Smooth_BlendSmooth(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Smooth_Fog(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Smooth_Fog_Blend(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Smooth_Fog_BlendSmooth(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat_Blend(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat_BlendSmooth(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat_Fog(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat_Fog_Blend(brp_block *block, brp_vertex *v0,brp_vertex *v1);
void BR_ASM_CALL LineRender_Flat_Fog_BlendSmooth(brp_block *block, brp_vertex *v0,brp_vertex *v1);
...
void BR_ASM_CALL _MemFill3DFX_A(char *dest,
	br_uint_32 dest_qual, br_uint_32 pixels, br_uint_32 colour);
...
void BR_ASM_CALL _MemRectCopy3DFX_A(char *dest,
	br_uint_32 dest_qual, char *src, br_uint_32 src_qualifier, 
	br_uint_32 pwidth, br_uint_32 pheight,
	br_uint_32 d_stride, br_uint_32 s_stride);
