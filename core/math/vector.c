 ...
 * v1=v2*scalar
 */
void BR_PUBLIC_ENTRY BrVector2Scale(br_vector2 *v1, const br_vector2 *v2, const br_scalar s)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 * v1=v2*scalar
 */
void BR_PUBLIC_ENTRY BrVector3Scale(br_vector3 *v1, const br_vector3 *v2, const br_scalar s)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 * v1=v2/scalar
 */
void BR_PUBLIC_ENTRY BrVector3InvScale(br_vector3 *v1, const br_vector3 *v2, const br_scalar s)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 */
br_scalar BrFVector2Dot(br_fvector2 *v1, const br_vector2 *v2)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 * v1=v2
 */
void BrFVector3Copy(br_fvector3 *v1, const br_vector3 *v2)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 * v1=v2*scalar
 */
void BrVector3ScaleF(br_vector3 *v1, const br_fvector3 *v2, const br_scalar s)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 *  = v1.v2 (v1 is a unit vector (word components))
 */
br_scalar BrFVector3Dot(br_fvector3 *v1, const br_vector3 *v2)
{
        UASSERT_MESSAGE("Destination Vector is NULL", v1 != NULL);
        UASSERT_MESSAGE("Source Vector is NULL", v2 != NULL);
 ...
 * v1 = v2/|v2|
 */
void BrFVector3Normalise(br_fvector3 *v1, const br_vector3 *v2)
{
	br_scalar scale;
 ...
 * v1 = v2/|v2| (low precision)
 */
void BrFVector3NormaliseLP(br_fvector3 *v1, const br_vector3 *v2)
{
