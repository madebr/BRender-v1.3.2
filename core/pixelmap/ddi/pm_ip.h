...
br_clip_result BR_RESIDENT_ENTRY PixelmapLineClip(br_point *s_out, br_point *e_out, const br_point *s_in, const br_point *e_in, const br_pixelmap *pm);
